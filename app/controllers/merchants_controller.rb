class MerchantsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @merchant.save
        format.html { redirect_to new_merchant_basic_verification_path(@merchant), notice: "Merchant was successfully created." }
  ...
  private
    ...
    def merchant_params
      params.require(:merchant).permit(:first_name, :last_name)
    end
end
