...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference("Merchant.count") do
      post merchants_url, params: { merchant: { first_name: @merchant.first_name, last_name: @merchant.last_name } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { first_name: @merchant.first_name, last_name: @merchant.last_name } }
